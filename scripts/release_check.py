...
REQUIRED_FILES = [
    ...
    "docs/ROUTING.md",
    "docs/SECURITY.md",
    "examples/fixtures/duplicate/SKILL.md",
    "examples/fixtures/explicit-platform/SKILL.md",
    "examples/fixtures/manual-review/SKILL.md",
    "examples/fixtures/reject/SKILL.md",
    "examples/fixtures/safe-new/SKILL.md",
    "examples/intake-report.md",
    "examples/workflow-report.md",
    "scripts/fixture_check.py",
    "scripts/install.sh",
    ...
    "skills/skill-intake/scripts/intake_workflow.py",
